...
/*    QString un(getenv("USERNAME"));
    if (un != ""){
        ...
        buff[len] = '\0';
		NET_API_STATUS ret = NetUserGetInfo(nullptr, buff, 23, (BYTE**)&user_info);
        if (ret == ERROR_INVALID_LEVEL) {
			QMessageBox::information(nullptr, "1", "NOT SUPPORTED", QMessageBox::Ok);
        }
        else if (ret == ERROR_SUCCESS) {
*/            /*QMessageBox::information(nullptr, "1", "SUCCESSO", QMessageBox::Ok);
            QString dato = QString::fromWCharArray(user_info->usri24_internet_provider_name);
			QMessageBox::information(nullptr, "1", "A" + dato, QMessageBox::Ok);
            dato = QString::fromWCharArray(user_info->usri24_internet_principal_name);
			QMessageBox::information(nullptr, "1", "B" + dato, QMessageBox::Ok);*/
/*            QString dato = QString::fromWCharArray(user_info->usri23_full_name);
			...
			QMessageBox::information(nullptr, "1", "ERRORE", QMessageBox::Ok);
        }
*/        /*else {
            QString fullname = QString::fromWCharArray(user_info->usri24_internet_principal_name);
			QMessageBox::information(nullptr, "1", fullname, QMessageBox::Ok);
        }*/
